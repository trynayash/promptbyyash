      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-600 mb-4 pr-4">
              Enhancing your AI interactions with smarter, more powerful prompts.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-promptp-purple">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-promptp-purple">
                  Features
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {currentYear} PromptP. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 space-x-6">
            <a href="#" className="text-gray-500 text-sm hover:text-promptp-purple">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-500 text-sm hover:text-promptp-purple">
              Terms of Service
